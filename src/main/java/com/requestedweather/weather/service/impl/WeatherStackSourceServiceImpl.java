...
public class WeatherStackSourceServiceImpl implements WeatherAnotherSourceService {
    ...
    private static final String URL_ADRESS = "https://api.weatherstack.com/current?access_key=%s&query=%s";
    ...
    protected Double getTemperatureByCity(String city) {
        ...
        try {
            ...
            temperature = jsonObject.getJSONObject("current").getDouble("temperature");
    ...
    protected String getDataTemperatureByCity(String city) {
        ...
        try {
            URL url = new URL(String.format(URL_ADRESS, apiKey, city));
